"""
This script generates a XOR data set and saves it for future use in Machine Learning tasks. 
It allows a separate instance for training (labeled data) and inference (unlabeled data).
"""
